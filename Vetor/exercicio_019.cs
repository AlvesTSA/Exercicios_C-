...
class exercicio_019{
    ...
    static void Main(){
        ...
        Console.WriteLine("Projeçao de Gastos com Abono\n============================");
        ...
        Console.WriteLine("Salário    - Abono");

        for (int i = 0; i < count1; i++){

            Console.WriteLine("R$ " + salario[i] + " -  R$" + abono[i]);
        }
        
        Console.WriteLine("Foram processados " + count1 + " colaboradores");
        Console.WriteLine("Total gasto com abonos: R$ " + total);
        Console.WriteLine("Valor mínimo pago a " +  count2 + " colaboradores");
        Console.WriteLine("Maior valor de abono pago: R$ " + maior_abono);
    }
}